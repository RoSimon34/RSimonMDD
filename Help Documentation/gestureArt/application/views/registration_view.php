...
-->
	...
	<!-- <?php echo link_tag('css/themes/style.css'); ?> -->
...
<?php $this->load->helper('html'); ?>
				...
				<ul data-role="listview" data-inset="true" data-filter="true" data-filter-placeholder="Search Artist Name or Project">
					<li>
						<a href="#detail" data-transition="flip">
							...
							<div class="vote_section">
								...
								<?php $this->load->helper('html'); ?>
								<?php echo img('/images/t_up_listP.png'); ?>
								<h2>300</h2>
					...
					<li>
						<a href="#detail" data-transition="flip">
							...
							<?php echo img('/images/art2.png'); ?>
							
							<h2>ASIAN INFLUENCE</h2>
							<p>By: Bruce Chin</p>
							<div class="vote_section">
								<!-- <img src="images/t_up_listP.png" /> -->
								<?php $this->load->helper('html'); ?>
		...
		<div data-role="footer" data-position="fixed">
			<div data-role="navbar">
				<ul>
					<li><a href="#register_view" data-mini="true" data-theme="a" data-transition="flip">Sign Up For Free</a></li>

	...
	<div data-role="page" id="home" class="wrapper">
		...
		<div data-role="header" data-theme="c" class="header_content">
			...
			<div data-role="controlgroup" data-type="horizontal" data-mini="true">
				<a href="#home" data-role="button" data-iconpos="notext" data-icon="home" data-theme="b" data-transition="flow" data-prefetch>Home</a>
				<a href="#userpanel" data-role="button" data-iconpos="notext" data-icon="bars" data-iconpos="notext" data-theme="b" data-inline="true" data-prefetch>Bars</a>
		...
		<div data-role="footer" data-position="fixed" class="footer_content">
			<div data-role="navbar">
				<ul>
					<li><a href="#register_view" data-mini="true" data-theme="b" data-transition="flip" data-prefetch>Sign Up For Free</a></li>
					<li><a href="#login_view" data-mini="true" data-theme="a" data-transition="flip" data-prefetch>Login</a></li>
				</ul>
			</div><!-- Nav bar -->
		</div><!-- end footer div -->
		...
		<div data-role="panel" id="mypanel" data-position-fixed="true" data-display="push">
			<ul data-role="listview" data-theme="a" class="nav-search">
	            <li data-icon="delete"><a href="#" data-rel="close" data-prefetch>Close menu</a></li>
	            ...
	            <li data-theme="b"><a href="#help_view" data-transition="pop" data-prefetch>Help / FAQ</a></li>
	            <!-- <li data-theme="b"><?php echo anchor('user/logout', 'Logout',array('data-transition'=>"flow")); ?></li> -->
	        </ul>
    	</div><!-- /panel -->
...
<!-- ========================================================== Detail Page Section ================================================ -->
	...
	<div data-role="page" id="detail_view" class="wrapper">
		...
		<div data-role="header" data-theme="c">
			...
			<a href="#home" data-role="button" data-icon="home" class="ui-btn-left" data-iconpos="notext" data-theme="b" data-transition="flow" data-prefetch>Home</a>
		</div><!-- end header div-->
		...
		<div data-role="footer" data-position="fixed">
			<div data-role="navbar">
				<ul>
					<li><a id="1_upvote" class="voteMe"><img src="http://www.technicalkeeda.com/img/images/up_vote.png"/></a></li>
					<li><a id="1_downvote" class="voteMe"><img src="http://www.technicalkeeda.com/img/images/down_vote.png"/></a></li>
					
					
					<!--
<li><a id="1_upvote" class="voteMe"><img src="http://www.technicalkeeda.com/img/images/up_vote.png"/></a><span id="1_upvote_result" >10</span></li>
					<li><a id="1_downvote" class="voteMe"><img src="http://www.technicalkeeda.com/img/images/down_vote.png"/></a><span id="1_downvote_result" >1</span></li>
-->
					
					<!--
<li><a href="#" data-mini="true" data-theme="b" data-transition="flip">Thumbs Up</a></li>
					<li><a href="#" data-mini="true" data-theme="b" data-transition="flip">Thumbs Down</a></li>
-->
					<li><a href="#comment_view" data-mini="true" data-theme="b" data-transition="flip" data-prefetch>Comment</a></li>
				</ul>
			</div><!-- Nav bar -->
		</div><!-- end footer div -->
...
<div data-role="page" id="comment_view" class="wrapper" data-theme="b">
		...
		<div data-role="header" data-theme="c">
			...
			<h1><?php echo $file->title?></h1>
			<a href="#home" data-role="button" data-icon="home" data-theme="b" data-iconpos="notext" class="ui-btn-left" data-transition="flow" data-prefetch>Home</a>
		</div><!-- end header div-->
		...
		<div data-role="content" id="comment_content">
			<?php $result=$this->_ci_cached_vars["result"];?> 
			
			<div class="project_comments">
		        <?php foreach ($result as $comment): ?>
		        
		        
		            <p class="commenter_name">Name: <?php echo $comment["username"]?></p>
		            <p class="commenter_message">Comment: <?php echo $comment["message"]?></p>
		            <!-- </div> -->
		            
		        <? endforeach; ?>
			</div><!-- end of project_comment-->
		...
		<div data-role="footer" data-position="fixed" data-theme="c" id="comment_form">
			<?php echo form_open("user/comments"); ?>
				<p>
					<label for="username">Your Name</label>
					<input type="text" id="username" name="username" value="" />
					<!-- <input type="hidden" id="id" name="id" value="<?php echo $comment["id"]?>" /> -->
					<input type="hidden" id="id" name="id" value="<?php echo $this->session->userdata('user_id')?>" />
				</p>        
				<p>
					<label for="message">Comment</label>
					<input type="text" id="comment" name="message" value="" />
				</p>
					<br/>
...
<div data-role="page" id="login_view" class="wrapper" data-theme="b">
		...
		<div data-role="header" data-theme="c">
			<h1>Login Below</h1>
			<a href="#home" data-role="button" data-icon="home" data-iconpos="notext" data-theme="b" class="ui-btn-left" data-transition="flow" data-prefetch>Home</a>
		</div><!-- end header div-->
...
<div data-role="page" id="register_view" class="wrapper" data-theme="b">
		...
		<div data-role="header" data-theme="c">
			<h1>Sign Up Below</h1>
			<a href="#home" data-role="button" data-icon="home" data-theme="b" class="ui-btn-left" data-transition="flow" data-iconpos="notext" data-prefetch>Home</a>
		</div><!-- end header div-->
...
<div data-role="page" id="copyright_view" class="wrapper" data-theme="c">
		<header><!-- header contains the logo which is within a image tag-->
			<!-- <h1><img src="images/dt_logo.png"/></h1> -->
		...
		<div data-role="header" data-theme="c">
			...
			<a href="#home" data-role="button" data-icon="home" class="ui-btn-left" data-transition="flow" data-iconpos="notext" data-prefetch>Home</a>
		</div><!-- end header div-->
...
<div data-role="page" id="terms_view" class="wrapper" data-theme="b">
		...
		<!-- Below is the main content div of this section / page. it houses all the content i want to present to the user. -->
		<div data-role="content" id="terms_content">	
...
<div data-role="page" id="copyright_view" class="wrapper" data-theme="b">
		...
		<!-- Below is the main content div of this section / page. it houses all the content i want to present to the user. -->
		<div data-role="content" id="coprright_content">	
...
<div data-role="page" id="contact_view" class="wrapper" data-theme="b">
		...
		<div data-role="header" data-theme="c">
			...
			<a href="#home" data-role="button" data-theme="b" data-icon="home" data-iconpos="notext" class="ui-btn-left" data-transition="flow">Home</a>
		</div><!-- end header div-->
			
		<!-- Below is the main content div of this section / page. it houses all the content i want to present to the user. -->
		<div data-role="content" id="contact_content">	
...
<div data-role="page" id="help_view" class="wrapper">
		<header><!-- header contains the logo which is within a image tag-->
			<!-- <h1><img src="images/logo_small.png"/></h1> -->
		...
		<div data-role="header" data-theme="c">
			<h1>FAQ</h1>
			<a href="#home" data-role="button" data-icon="home" class="ui-btn-left" data-iconpos="notext" data-transition="flow" data-theme="b" data_prefectch>Home</a>
		</div><!-- end header div-->
		
		<!-- Below is the main content div of this section / page. it houses all the content i want to present to the user. -->
		<div data-role="content" id="faq_content">	
